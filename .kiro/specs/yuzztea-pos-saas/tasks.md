...
- [x] 1. Bootstrap project dan tooling
  - [x] 1.1 Inisialisasi Vite + React 18 + TypeScript SPA dengan struktur folder src/{app,domain,data,features,components,lib,styles,test}
    ...
    - _Requirements: 13.4_
  - [x] 1.2 Konfigurasi Tailwind + token brand Yuzztea + dark mode `class`
  ...
  - [x] 1.3 Setup Vitest + fast-check + Testing Library + jsdom
  ...
  - [x] 1.4 Setup Playwright untuk E2E + visual
  ...
  - [x] 1.5 Setup ESLint + Prettier + commit hooks
    ...
    - _Requirements: 13.4_
  - [x] 1.6 Konfigurasi env + Supabase client wrapper
...
- [x] 2. Supabase backend: schema, RLS, dan SECURITY DEFINER functions
  ...
  - [x] 2.3 Skema transaction, transaction_line, refund, stock_receiving, stock_opname, audit_log
...
- [ ] 3. Shared Zod validators (Property 16)
  - [x] 3.1 Implementasi seluruh schema entitas di `src/domain/validators/index.ts`
